...
class DQN:
    def __init__(self, alpha, state_dim, action_dim, fc1_dim, fc2_dim, ckpt_dir,
                 gamma=0.95, tau=0.005, epsilon=1.0, eps_end=0.01, eps_dec=5e-4,
    ...
    def choose_acion(self, observation, isTrain=True):
    ...
    def save_best_models(self):
        self.q_eval.save_checkpoint(self.checkpoint_dir + 'Q_eval/best_DQN_Q_eval.pth')
        print('Saving Q_eval network successfully!')
